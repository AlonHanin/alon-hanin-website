  ...
  he: [
    {
      ...
      result: "המוצר עדיין בפיתוח, ולכן בשלב זה לא מוצגת תוצאה תפעולית לאחר הטמעה.",
    ...
    },
    {
      ...
      result: "הדיווח באפליקציה, בדיקת המנהלים וצבירת הנקודות מחוברים לתהליך אחד מול השרת ומסד הנתונים.",
      relatedServiceId: "mobile-apps",
    ...
    },
    {
      ...
      result: "נתוני הדירוגים, הביקורות, זמן המשחק והמחיר מוצגים יחד בדשבורד שמאפשר להשוות ולחקור אותם.",
      relatedServiceId: "web-apps",
    ...
    },
    {
      ...
      result: "המבקרים יכולים לעבור בין מידע על אימוץ, אירועים והתנדבות ולשלוח טפסים שנשמרים בצד השרת.",
      relatedServiceId: "business-websites",
  ...
  en: [
    {
      ...
      result: "The product is still in development, so no post-implementation operational result is presented yet.",
      relatedServiceId: "business-systems",
    ...
    },
    {
      ...
      result: "App submissions, administrator review and points tracking are connected in one workflow backed by the server and database.",
      relatedServiceId: "mobile-apps",
    ...
    },
    {
      ...
      result: "Ratings, reviews, playtime and pricing data are presented together in a dashboard where they can be compared and explored.",
      relatedServiceId: "web-apps",
    ...
    },
    {
      ...
      result: "Visitors can move between adoption, event and volunteer information and submit forms that are stored on the server.",
      relatedServiceId: "business-websites",
