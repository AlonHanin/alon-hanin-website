...
// Device framing is presentation only; the supplied screenshots stay unchanged.
export function ProjectCover({ project }: { project: Project }) {
  ...
  return <div aria-hidden="true" className={`project-cover project-cover-${project.visual}`}>
    ...
    <div className={phone ? "project-cover-phones" : "project-cover-browser"}>
      {images.filter(Boolean).map((image) => <div key={image.src} className={phone ? "project-cover-phone" : "project-cover-screen"}>
